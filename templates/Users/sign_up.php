        ...
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            ...
            <?= $this->Flash->render() ?>
              ...
              <?php echo $this->Form->create($user ,['id' => 'form']) ?>
             
              <?php echo $this->Form->control('user_profile.first_name', ['required' => false, 'class' => 'form-control ', 'label' => ['class' => 'form-label']]) ?>
              <?php echo $this->Form->control('user_profile.last_name', ['required' => false, 'class' => 'form-control mt-3 ', 'label' => ['class' => 'form-label  mt-3']]) ?>
              <?php echo $this->Form->control('email', ['required' => false, 'class' => 'form-control mt-3', 'label' => ['class' => 'form-label mt-3']]) ?>
             
              <label for="" > Choose User Type  <span class="pr"></span></label><br>
